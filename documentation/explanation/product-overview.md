...
> 路线图详见 [roadmap.md](../roadmap.md) | 现状详见 [reference/current-status.md](../reference/current-status.md)

## 1. 产品定位

| 维度 | 定义 |
|------|------|
| 产品名 | Stock Copilot（智策 NexStrat） |
| 一句话 | **日更情报 + 推荐池 + 盘中预警 + 复盘进化** 的 A 股 AI 战术助手 |
| 目标用户 | 有个人炒股经验、希望提升决策效率的投资者（Phase 1 自用） |
| 核心价值 | 聚合行情/公告/资金 → 日更 digest → 3×3 推荐池 → 竞价/盘中闭环 → 复盘进化 |
