...
## Phase G SQLite 表（3.0.0-alpha）

见 [knowledge-base-schema.md](knowledge-base-schema.md)、[recommendation-engine.md](recommendation-engine.md)。

| 表 | 用途 |
|----|------|
| `market_events` | 热点/宏观/行业事件 |
| `daily_digest` | 日更情报聚合 |
| `overnight_snapshots` | 外盘快照 |
| `futures_snapshots` | 期货快照 |
| `recommendation_pool` | 战术推荐池 3×3 |
| `auction_snapshots` | 竞价指标 |
| `alerts` | 盘中/仓位预警 |
| `positions` / `position_rules` | 单用户仓位 |
| `recommendation_reviews` | 盘后 hit/miss |
